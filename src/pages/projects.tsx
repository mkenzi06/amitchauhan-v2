        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="my-2">
            <span className="text-sm text-muted-foreground">
             Ici quelques projet que j'aimerai partager avec vous.
            </span>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-5xl text-center text-foreground md:mt-28">
            ...
            Je travaille actuellement sur de nouveaux projets et j'apprends le développement backend avec de nouvelles technologies pour élargir mes compétences dans le devops.
            </span>
